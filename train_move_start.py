"""
train_move_start.py — Train LightGBM to predict if a 0.5% move starts within 1h.

Two-stage model:
1. had_move: binary (did a 0.5% move start?)
2. move_direction: on had_move=1 only (up or down?)

Prints top 10 expectancy rows and top 20 features by importance.
"""
...
OUTPUT_FILE = "data/expectancy_table_move_start.csv"
